  ...
  void _login() async {
    ...
    try {
      ...
      if (doc.exists && doc.data() != null) {
        // FIXED: Casting to Map to avoid JavaScript subtype error
        Map<String, dynamic> data = doc.data() as Map<String, dynamic>;
        String role = (data['role'] ?? 'student').toString().toLowerCase().trim(); 

        debugPrint("✅ Successful Role Fetch: $role");
        ...
        _showSnackBar("Aapka data database mein nahi mila!", Colors.red);
      }
    } on FirebaseAuthException catch (e) {
      _showSnackBar(e.message ?? "Login Fail ho gaya", Colors.red);
    } catch (e) {
